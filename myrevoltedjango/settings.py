"""
Django settings for myrevoltedjango project.
...
SECRET_KEY = 'django-insecure-!se0$37dn0&kwjia((+gb4=qbk43&$&f%y@3243rvhj^vz*@&+'
...
ROOT_URLCONF = 'myrevoltedjango.urls'
...
WSGI_APPLICATION = 'myrevoltedjango.wsgi.application'
